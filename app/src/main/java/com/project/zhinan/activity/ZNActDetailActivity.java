...
// titleUrl是标题的网络链接，QQ和QQ空间等使用
        oks.setTitleUrl("http://120.27.41.245:2888/");
// text是分享文本，所有平台都需要这个字段
        oks.setText("欢迎下载指南App，参与该活动 Url:http://120.27.41.245:2888/");
// imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        oks.setImagePath(Environment.getExternalStorageDirectory().getPath()+"/zhinan/qcoder.png");//确保SDcard下面存在此张图片
// url仅在微信（包括好友和朋友圈）中使用
        oks.setUrl("http://120.27.41.245:2888/");
// comment是我对这条分享的评论，仅在人人网和QQ空间使用
        oks.setComment("我是测试评论文本");
// site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite(getString(R.string.app_name));
// siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl("http://120.27.41.245:2888/");
